...
export const data = [
  ...
  {
    headline: `Day 02: Srinagar - Aharbal`,
    description: `
    Aharbal is known for its waterfall,Aharbal is located 50km north to srinagar with mesmerized water falls and Trekking on site landscape.
